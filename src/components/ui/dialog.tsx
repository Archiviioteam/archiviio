  ...
  return (
    <DialogPortal>
      ...
      <DialogPrimitive.Content
        ...
        className={cn(
          radius.surface,
          "fixed inset-0 z-[100] m-auto flex h-fit max-h-[calc(100dvh-var(--spacing-8))] w-[calc(100%-var(--spacing-8))] max-w-4xl flex-col gap-4 overflow-y-auto overflow-x-hidden bg-card p-6 outline-none max-md:max-h-[calc(100dvh-var(--spacing-8))] max-md:w-[calc(100%-var(--spacing-8))] max-md:p-5 max-md:touch-pan-y max-md:[&_input]:text-base max-md:[&_textarea]:text-base max-md:[&_select]:text-base",
          elevation.lg,
          motion.modalContent,
          className
        )}
  ...
  return (
    <div
      ...
      className={cn(
        ...
        "max-md:sticky max-md:bottom-0 max-md:z-10 max-md:mt-auto max-md:rounded-xl max-md:border max-md:border-border/70 max-md:bg-white max-md:p-2 max-md:shadow-sm",
